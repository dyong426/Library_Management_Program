...
public class MemberVO {
	...
	public MemberVO(Integer mem_num, String mem_name,String mem_phone,String mem_email,String mem_address,String mem_note) {
		this.num = mem_num;
		this.name = mem_name;
	...
	public MemberVO(String mem_pw, Integer mem_num, String mem_name, String mem_phone, String mem_email, String mem_address) {
		this.pw = mem_pw;
		this.num = mem_num;
		this.name = mem_name;
		this.phone = mem_phone;
